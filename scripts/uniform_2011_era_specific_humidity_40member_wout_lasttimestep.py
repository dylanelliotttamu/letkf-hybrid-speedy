...
plt.plot(date_list,analysis_rmse,color='r',label='RMSE Hybrid 40 member') #cov-infl1.3
plt.plot(date_list,analysis_rmse_speedy,color='b',label='RMSE SPEEDY 40 member')
