...
analysis_file = '/skydata2/dylanelliott/letkf-hybrid-speedy/DATA/uniform_letkf_anal/analysis_dylan_hybrid_test.nc'#'/skydata2/dylanelliott/letkf-hybrid-speedy/DATA/uniform_letkf_anal/uniform_analysis_hybrid_2012_01_to_2012_05.nc' 
...
xgrid = 96
ygrid = 48
length = 1253#480 # 240 for 3 months  #1450 ##338 #160#64#177#1400#455
...
plt.xlim([datetime(2011, 1, 1,0), datetime(2012, 3, 30,0)])
plt.ylim(0,10)
plt.show()
