...
start_year = 2011#2000

startdate = datetime(2011,1,1,0)#datetime(2000,1,1,0)
...
#'/skydata2/dylanelliott/letkf-hybrid-speedy/DATA/30yr_uniform_letkf_anal/uniform_analysis_81_12.nc'
...
analysis_file = '/skydata2/dylanelliott/letkf-hybrid-speedy/DATA/uniform_letkf_anal/uniform_hybrid_anal_Jan1_May1_2011.nc' 
#uniform_hybrid_anal_Jan1_May1_2011.nc
#'/skydata2/troyarcomano/letkf-hybrid-speedy/experiments/hybrid_first_test/anal_mean.nc' 
#'/skydata2/troyarcomano/letkf-hybrid-speedy/DATA/ensemble/anal/mean/test.nc' 
#'~/stable_run/rtpp_0_3.nc' #'/skydata2/troyarcomano/letkf-hybrid-speedy/DATA/ensemble/anal/mean/test.nc'
...
xgrid = 96
ygrid = 48
length = 480 # 240 for 3 months  #1450 ##338 #160#64#177#1400#455
...
cf = ax1.contourf(lons2d, lats2d,cyclic_data,levels=np.arange(0,10.1,1),extend='both')
...
cf = ax2.contourf(lons2d, lats2d,cyclic_data,levels=np.arange(0,10.1,1),extend='both')
plt.colorbar(cf,label='(m/s)')
...
#plt.xticks([datetime(2011, 1, 1,0),datetime(2011, 3, 1,0)],6)
