...
xgrid = 96
ygrid = 48
length = 1952#240  #1450 ##338 #160#64#177#1400#455
...
cf = ax3.contourf(lons2d, lats2d,cyclic_data,levels=np.arange(-.7,.8,.005),extend='both',cmap='seismic')
...
plt.title('30 MEMBER ENSEMBLE for Hybrid & SPEEDY \nLETKF Analysis Error\n Low Level Specific Humidity')
...
plt.xlim([datetime(2011, 1, 1,0), datetime(2012, 5, 1,6)])
