...
xgrid = 96
ygrid = 48
length = 1952-7#240  #1450 ##338 #160#64#177#1400#455
...
plt.title('30 MEMBER ENSEMBLE Hybrid and SPEEDY\nLETKF Analysis Error\n Low Level Temperature')
...
plt.xlim([datetime(2011, 1, 1,0), datetime(2012, 5, 5,0)])
plt.ylim(2,2.8)
plt.show()
...
#plt.ylabel('Analysis Error (kg/kg)')
#plt.ylabel('Ensemble Spread (K)')
plt.xlim([datetime(2012, 4, 29,0), datetime(2012, 5, 5,0)])
plt.ylim(2,2.8)
plt.show()
