...
startdate = datetime(2012,1,1,0)
enddate = datetime(2012,5,1,0)

nature_file = f'/skydata2/troyarcomano/ERA_5/{start_year}/era_5_y{start_year}_regridded_mpi_fixed_var.nc'
analysis_file_speedy = '/skydata2/dylanelliott/letkf-hybrid-speedy/DATA/uniform_letkf_anal/uniform_analysis_2012_01_to_2012_09.nc'
...
analysis_file = '/skydata2/dylanelliott/letkf-hybrid-speedy/DATA/uniform_letkf_anal/uniform_analysis_hybrid_2012_01_to_2012_05.nc'
...
plt.xlim([datetime(2012, 1, 1,0), datetime(2012, 5, 1,0)])
plt.show()

# plot of spin-ups 1 month
...
#plt.ylabel('Analysis Error (kg/kg)')
#plt.ylabel('Ensemble Spread (K)')
plt.xlim([datetime(2012, 1, 1,0), datetime(2012, 1, 31,0)])
plt.show()
