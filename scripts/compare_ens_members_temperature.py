...
var_era = 'Temperature'#'Temperature' #'V-wind'
var_da =  't'#'t'#'q'
...
#
#plt.colorbar(cf,label='(K)',fraction=0.046, pad=0.04)
...
#plt.colorbar(cf,label='(K)',fraction=0.046, pad=0.04)
#ax2.set_title('COV 1.5 SPEEDY LETKF Analysis Error \n Low Level Temperature')
...
#plt.colorbar(cf,label='(K)',fraction=0.046, pad=0.04)
#plt.tight_layout()
##plt.savefig('degrees/MAP_OF_TEMP.pdf',dpi=1200)
##plt.savefig('degrees/MAP_OF_TEMP.jpeg',dpi=1200)
#plt.show()
...
#plt.title('COV 1.5 for New Hybrid & SPEEDY\nLETKF Analysis Error\nLow Level Temperature')
...
#plt.ylim(1.5,2.8)
#plt.tight_layout()
##plt.savefig('degrees/PLOT_OF_TEMP.pdf',dpi=1200)
##plt.savefig('degrees/PLOT_OF_TEMP.jpeg',dpi=1200)
#plt.show()
...
#analysis_file = '/skydata2/dylanelliott/letkf-hybrid-speedy/DATA/uniform_letkf_anal/uniform_20member_hybrid_jan1_dec31_2011.nc'
analysis_file = '/skydata2/dylanelliott/letkf-hybrid-speedy/DATA/uniform_letkf_anal/30member_hybrid_20110101_2011082212_cov_infl_1_5/mean.nc'
#'/skydata2/troyarcomano/letkf-hybrid-speedy/experiments/hybrid_first_test/anal_mean.nc' #'/skydata2/troyarcomano/letkf-hybrid-speedy/DATA/ensemble/anal/mean/test.nc' #'~/stable_run/rtpp_0_3.nc' #'/skydata2/troyarcomano/letkf-hybrid-speedy/DATA/ensemble/anal/mean/test.nc'
spread_file =  '/skydata2/troyarcomano/letkf-hybrid-speedy/experiments/hybrid_first_test/anal_sprd.nc' #'/skydata2/troyarcomano/letkf-hybrid-speedy/DATA/ensemble/anal/mean/test.nc' #'~/stable_run/rtpp_0_3.nc' # '/skydata2/troyarcomano/letkf-hybrid-speedy/DATA/ensemble/anal/mean/test.nc'
...
plt.figure(figsize=(16,6))
'''1'''
plt.plot(date_list,analysis_rmse,color='g',linewidth=.75,label='RMSE Hybrid ') #cov-infl1.3
plt.axhline(y=np.average(analysis_rmse[20::]), color='g', linestyle='--',label="Average RMSE New Hybrid")
...
#plt.plot(date_list,analysis_rmse_speedy_3,color='y',linewidth=.75,label='RMSE SPEEDY 1.5')
#plt.axhline(y=np.average(analysis_rmse_speedy_3[20::]), color='y', linestyle='--',label="Average RMSE SPEEDY 1.5")
...
plt.ylim(2,2.8)
plt.tight_layout()
#plt.savefig('degrees/COMPARE_PLOT_OF_TEMP.pdf',dpi=1200)
#plt.savefig('degrees/COMPARE_PLOT_OF_TEMP.jpeg',dpi=1200)
