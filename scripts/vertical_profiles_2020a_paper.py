...
def get_speedy_files(truthfiles):
    ...
    speedy_data_dir = '/skydata2/troyarcomano/temp_storage/'
    speedyfiles = list()
...
def get_parallel_files(truthfiles,pattern):
    parallel_data_dir = '/skydata2/troyarcomano/arcomano_2022_paper/'#parallel_prediction_data/'
...
def get_llr_files(truthfiles,pattern):
    llr_data_dir = '/skydata2/troyarcomano/Predictions/Hybrid/'
    llr_files = list()
    for i in range(len(truthfiles)):
        truthfile = truthfiles[i]
        endfile = truthfile[-16:-3]
    ...
    for truth_file,forecast_file in zip(truth_files,forecast_files):
        ...
        for var,backup_var in zip(variables,backup_vars):
            ...
            if climatology:
               ...
               ds_climo = xr.open_dataset('/skydata2/troyarcomano/temp_storage/regridded_era_climatology1990_2010.nc') 
...
def plot_surface_tendecy(speedy_files,truth_files,hybrid_files,parallel_files,llr_files,variable,backup_var,unit):
    ...
    plotdir = '/skydata2/troyarcomano/arcomano_2022_paper/'
    ...
    plt.plot(plot_times,mean_hybrid_tendency[index_times]/6.0,color='r',ls='-',linewidth=2.0,label='Hybrid')
    plt.plot(plot_times,mean_speedy_tendency[index_times]/6.0,color='k',ls='-',linewidth=2.0,label='SPEEDY')
    plt.plot(plot_times,mean_parallel_tendency[index_times]/6.0,color='g',ls='-',linewidth=2.0,label='ML')
    plt.plot(plot_times,mean_era_tendency[index_times]/6.0,color='b',ls='-',linewidth=2.0,label='ERA')
...
def mean_and_var_error_3panel_6hr(speedy_files,truth_files,hybrid_files,region,trialname,xlimit_array,parallel_files=None,llr_files=None):
    ...
    plot_times_speedy = np.arange(0,57)
    plot_times_llr = np.arange(0,45)
    plot_times_parallel = np.arange(0,57)

    forecast_times = np.arange(1,57)
    forecast_times_speedy = np.arange(1,57)
    forecast_times_llr =  np.arange(1,45)
    forecast_times_persistence = np.arange(0,57)
    forecast_times_parallel =  np.arange(1,57)
    ...
    ###Varibles Data ####
    mean_persistence_error,mean_speedy_error, var_persistence_error, var_speedy_error = average_mean_and_var_error_better(variables,backup_vars,truth_files,speedy_files,plot_times,region,stride=6)
    ...
    if parallel_files is not None:
       mean_persistence_error_par, mean_parallel_error, var_persistence_error_par, var_parallel_error = average_mean_and_var_error_better(variables,backup_vars,truth_files,parallel_files,plot_times_parallel,region,stride=2)
    if llr_files is not None:
    ...
    ax1.plot(plot_times_speedy,[0]+list(mean_speedy_error[0,-1,forecast_times_speedy]),color='k',ls='-',linewidth=2.0,label='SPEEDY Mean Error')
    ax1.plot(plot_times_speedy,[0]+list(var_speedy_error[0,-1,forecast_times_speedy]),color='k',ls='--',linewidth=2.0,label='SPEEDY SD Error')
    ax1.plot(plot_times[forecast_times],mean_hybrid_error[0,-1,forecast_times],color='r',ls='-',linewidth=2.0,label='Hybrid Mean Error')
    ax1.plot(plot_times[forecast_times],var_hybrid_error[0,-1,forecast_times],color='r',ls='--',linewidth=2.0,label='Hybrid SD Error')
    ...
    if llr_files is not None:
       ...
       print('test')
    if parallel_files is not None:
       ax1.plot(plot_times_parallel[forecast_times_parallel],mean_parallel_error[0,-1,forecast_times_parallel],color='g',ls='-',linewidth=2.0,label='ML Model Mean Error')
       ax1.plot(plot_times_parallel[forecast_times_parallel],var_parallel_error[0,-1,forecast_times_parallel],color='g',ls='--',linewidth=2.0,label='ML Model SD Error')
    ...
    ax2.plot(plot_times_speedy,[0]+list(mean_speedy_error[2,-1,forecast_times_speedy]),color='k',ls='-',linewidth=2.0,label='SPEEDY Mean Error')
    ax2.plot(plot_times_speedy,[0]+list(var_speedy_error[2,-1,forecast_times_speedy]),color='k',ls='--',linewidth=2.0,label='SPEEDY SD Error')
    ax2.plot(plot_times[forecast_times],mean_hybrid_error[2,-1,forecast_times],color='r',ls='-',linewidth=2.0,label='Hybrid Mean Error')
    ax2.plot(plot_times[forecast_times],var_hybrid_error[2,-1,forecast_times],color='r',ls='--',linewidth=2.0,label='Hybrid SD Error')
    ...
    if llr_files is not None:
       ...
       print('test')
    if parallel_files is not None: 
       ax2.plot(plot_times[forecast_times_parallel],mean_parallel_error[2,-1,forecast_times_parallel],color='g',ls='-',linewidth=2.0,label='ML Model Mean Error')
       ax2.plot(plot_times[forecast_times_parallel],var_parallel_error[2,-1,forecast_times_parallel],color='g',ls='--',linewidth=2.0,label='ML Model SD Error')
    ...
    ax3.plot(plot_times_speedy,[0]+list(mean_speedy_error[1,2,forecast_times_speedy]),color='k',ls='-',linewidth=2.0,label='SPEEDY Mean Error')
    ax3.plot(plot_times_speedy,[0]+list(var_speedy_error[1,2,forecast_times_speedy]),color='k',ls='--',linewidth=2.0,label='SPEEDY SD Error')
    ax3.plot(plot_times[forecast_times],mean_hybrid_error[1,2,forecast_times],color='r',ls='-',linewidth=2.0,label='Hybrid Mean Error')
    ax3.plot(plot_times[forecast_times],var_hybrid_error[1,2,forecast_times],color='r',ls='--',linewidth=2.0,label='Hybrid SD Error')
    ...
    if llr_files is not None:
       ...
       print('test')
    if parallel_files is not None:
       ax3.plot(plot_times[forecast_times_parallel],mean_parallel_error[1,2,forecast_times_parallel],color='g',ls='-',linewidth=2.0,label='ML Model Mean Error')
       ax3.plot(plot_times[forecast_times_parallel],var_parallel_error[1,2,forecast_times_parallel],color='g',ls='--',linewidth=2.0,label='ML Model SD Error')
...
def panel_3by3_region_average_better(speedy_files,truth_files,hybrid_files,parallel_files,llr_files,region,variables,backup_vars,units,plot_times,trialname,xlimit_array,llr_truth_files):
    ...
    era_presistence_error_speedy, speedy_error, climo_error = rmse_average_better(variables,backup_vars,truth_files,speedy_files, plot_times,region,stride=6,climatology=True)#stride=6,climatology=True)
    ...
    era_presistence_error_parallel, llr_error = rmse_average_better(variables,backup_vars,llr_truth_files,llr_files,plot_times,region)
    ...
    for var,backup_var,unit,xlim in zip(variables,backup_vars,units,xlimit_array):
        for time in plot_times:
            ...
            if var == 'Specific-Humidity':
               ...
               ax.plot(hybrid_error[i,2::,time],pressure_levels_sp,color='#377eb8',ls='-',linewidth=2.0,label='Hybrid')
               ax.plot(speedy_error[i,2::,time],pressure_levels_sp,color='#4daf4a',ls='-',linewidth=2.0,label='SPEEDY')
               ax.plot(parallel_error[i,2::,time],pressure_levels_sp,color='#ff7f00',ls='-',linewidth=2.0,label='ML') 
               ax.plot(climo_error[i,2::,time],pressure_levels_sp,color='k',ls='-',linewidth=2.0,label='Climatology') 
               if time < 45*2:
                  continue
                  #ax.plot(llr_error[i,2::,int(time/2)],pressure_levels_sp,color='#984ea3',ls='-',linewidth=2.0,label='SPEEDY-LLR') 
            else:
               ...
               ax.plot(hybrid_error[i,:,time],pressure_levels,color='#377eb8',ls='-',linewidth=2.0,label='Hybrid')
               ax.plot(speedy_error[i,:,time],pressure_levels,color='#4daf4a',ls='-',linewidth=2.0,label='SPEEDY')
               ax.plot(parallel_error[i,:,time],pressure_levels,color='#ff7f00',ls='-',linewidth=2.0,label='ML')
               ...
               if time < 45*2:
                  ...
                  #ax.plot(llr_error[i,:,int(time/2)],pressure_levels,color='#984ea3',ls='-',linewidth=2.0,label='SPEEDY-LLR')

            ax.set_xlim(xlim)
            ax.tick_params(axis="x", labelsize=14)

            if var == 'Specific-Humidity':
               ax.set_title(f"{region} Specific Humidity Day {int((time*6)/24)}",fontsize=16,fontweight="bold") 
            else:
               ax.set_title(f"{region} {var} Day {int((time*6)/24)}",fontsize=16,fontweight="bold")
    ...
    plt.savefig(f'{plotdir}{region}_hybrid_three_panel_{trialname}.png')
    plt.savefig(f'{plotdir}{region}_hybrid_three_panel_{trialname}.pdf')
    plt.close("all")
...
#trialname = '6000_20_20_20_beta_res0.1_beta_model_0.01_prior_0.0_overlap1_era5_6hrtimestep_21yearsnontruncated_data_offbytimestep_fix_max_testtrial'
#trialname = '6000_20_20_20_beta_res0.1_beta_model_1.0_prior_1.0_overlap1_era5_6hrtimestep_tisrtrial' #best
#trialname = '6000_20_20_20_beta_res0.1_beta_model_1.0_prior_1.0_overlap1_era5_6hrtimestep_tisr_offbyonetrial' #paper 
trialname = '6000_20_20_20_beta_res0.1_beta_model_1.0_prior_1.0_overlap1_era5_6hrtimestep_tisr_offbyonetrial'
...
#trialname_parallel = '9000node_28_28_28_noise_beta_0.00001_3hrtimestep_full_data_tisr_test_false_overlap1trial'
trialname_parallel = '9000node_28_28_28_noise_beta_0.00001_3hrtimestep_21years_data_tisr_test_true_overlap1trial'

trialname_llr = 'no_reservoir_21yearsnontruncated_data_beta_model_200.0_prior_1.0_overlap1_era5_6hrtimesteptrial'
...
path = '/skydata2/troyarcomano/arcomano_2022_paper/'
...
#llr_files = get_files(path,llr_pattern)
...
llr_files = get_llr_files(truth_files,llr_pattern)
llr_truth_files = get_files(path,llr_truth_pattern)
...
llr_files = sorted(llr_files)
llr_truth_files = sorted(llr_truth_files)
...
print(len(parallel_files))
print(len(llr_files))
print(len(llr_truth_files))
...
#for truth_file,parallel_truth_file in zip(truth_files,parallel_truth_files):
#    print(truth_file[-16:-3])
    #print(parallel_truth_file[-16:-3])
...
region = 'Global'
mean_and_var_error_3panel_6hr(speedy_files[:],truth_files[:],hybrid_files[:],region,trialname,xlimit_array,parallel_files=parallel_files[:],llr_files=llr_files[:])
