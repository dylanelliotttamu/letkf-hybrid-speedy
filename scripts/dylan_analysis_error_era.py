...
startdate = datetime(2000,1,1,0)  #datetime(2000,1,1,0)
enddate = datetime(2001,1,4,0) #datetime(2001,1,5,0)
...
cf = ax1.contourf(lons2d, lats2d,cyclic_data,levels=np.arange(-15,15,1),extend='both',cmap='seismic')
plt.title('LETKF Analysis RMSE Difference of RTPP_0.8 to Multi_Cov_Infl_1.3\n for Low Level Spec Humidity (2000)\n')
plt.colorbar(cf,shrink=0.65)
plt.show()
...
base = datetime(2000,1,1,0)#datetime(2000,1,1,0)
...
plt.title('LETKF Analysis RMSE Averaged Over All Lat/Lon 2000\n Low Level Spec Humidity')
