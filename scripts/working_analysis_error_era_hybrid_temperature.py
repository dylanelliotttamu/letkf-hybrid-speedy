...
cf = ax1.contourf(lons2d, lats2d,cyclic_data,levels=np.arange(0,5.1,.1),extend='both')
...
cf = ax2.contourf(lons2d, lats2d,cyclic_data,levels=np.arange(0,5.1,.1),extend='both')
plt.colorbar(cf,label='(K)')
...
cf = ax3.contourf(lons2d, lats2d,cyclic_data,levels=np.arange(-5,5.1,.1),extend='both',cmap='seismic')
plt.colorbar(cf,label='(K)')
plt.show()
