...
start_year = 1989 #1982 #2000

startdate = datetime(1989,1,1,0)  #datetime(2000,1,1,0)
enddate = datetime(1989,12,30,0) #datetime(2001,1,5,0)
...
xgrid = 96
ygrid = 48
length = 338 #1450 ##338 #160#64#177#1400#455
...
plt.title('LETKF Analysis RMSE by Grid Point\n Low Level Specific Humdity')
plt.show()
...
plt.title('LETKF Analysis RMSE Difference between RTPP and Multi_Cov_Infl\n')
plt.colorbar(cf,shrink=0.6)
plt.show()
...
base = datetime(1989,1,1,0)#datetime(2000,1,1,0)
...
plt.xlim([datetime(1983, 1, 1,0), datetime(1983, 12, 31,0)])
plt.show()
