...
cf = ax1.contourf(lons2d, lats2d,cyclic_data,levels=np.arange(0,1.5,.0005),extend='both')
...
cf = ax2.contourf(lons2d, lats2d,cyclic_data,levels=np.arange(0,1.5,.0005),extend='both')
plt.colorbar(cf,label='(g/kg)',fraction=0.046, pad=0.04)
...
cf = ax3.contourf(lons2d, lats2d,cyclic_data,levels=np.arange(-.75,.75,.00005),extend='both',cmap='seismic')
plt.colorbar(cf,label='(g/kg)',fraction=0.046, pad=0.04)
plt.tight_layout()
plt.show()
