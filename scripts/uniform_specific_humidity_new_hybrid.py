...
plt.plot(date_list,analysis_rmse_4, color=blue_green,linewidth=.75,label='RMSE Hybrid 1.5,1.3')
plt.axhline(y=np.average(analysis_rmse_4[20::]), color=blue_green, linestyle='--',label="Average RMSE Hybrid 1.5, 1.3")
plt.axhline(y=np.average(analysis_rmse_4[20:592:]), color=blue_green, linestyle=':',label="6 Month Average RMSE Hybrid 1.5,1.3")
...
plt.axhline(y=np.average(analysis_rmse_2[20:-1:]), color='r', linestyle=':',label="Average RMSE Hybrid 1.3,1.3")
...
print('average rmse SPEEDY 1.3', np.average(analysis_rmse_speedy_4[20::]))
print('average rmse hybrid 1.5,1.3', np.average(analysis_rmse_4[20::]))
...
plt.tight_layout()
#plt.savefig("water/LETKF_Analysis_Error_Low_Level_Specific_Humidity.pdf",dpi=1200)
