...
analysis_file = '/skydata2/dylanelliott/letkf-hybrid-speedy/DATA/uniform_letkf_anal/newest_test_letkf.nc'#'/skydata2/dylanelliott/letkf-hybrid-speedy/DATA/uniform_letkf_anal/uniform_analysis_hybrid_2011_01_to_05_blowup_cov13.nc'
...
xgrid = 96
ygrid = 48
length = 613#480#240  #1450 ##338 #160#64#177#1400#455
...
plt.xlim([datetime(2008, 1, 1,0), datetime(2008, 8, 9,0)])
plt.ylim(0,0.005)
plt.show()
...
#plt.ylabel('Analysis Error (kg/kg)')
#plt.ylabel('Ensemble Spread (K)')
#plt.xlim([datetime(2011, 5, 1,0), datetime(2012, 3, 9,0)])
#plt.ylim(0,0.005)
#plt.show()
