...
do
    ...
    # original line above ^
    #
    # now overwrite anal with gues
        cp $OUTPUT/gues/$MEM/$YYYY$MM$DD$HH.grd $OUTPUT/anal/$MEM/$YYYY$MM$DD$HH.grd 
    # anal was made, but then overwritten. 
        echo "dylan trick $MEM done"  
    ...
    echo "dylan forecast from last forecast done"
