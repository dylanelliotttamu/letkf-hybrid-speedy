...
do
    ...
    cp /skydata2/dylanelliott/letkf-hybrid-speedy/DATA/hybrid_start_forecast_from_hybrid_anal_file_1_9_1_9_1_7/hybrid_anal_1_9_1_9_1_7_2011010700.grd $OUTPUT/gues/$MEM/$IYYYY$IMM$IDD$IHH.grd   
