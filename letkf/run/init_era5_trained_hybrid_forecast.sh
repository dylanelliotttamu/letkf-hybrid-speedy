...
# MAKE FORECASTS USING ERA5 trained weights   
#=======================================================================
set -e
...
# Need to change NATURE HERE TO CLIMO ENSEMBLE members --- I instead just commented it out below
NATURE=$SPEEDY/DATA/nature/nature_run_2000
...
do
    ...
    #cp /skydata2/dylanelliott/letkf-hybrid-speedy/DATA/climo_ensemble_files/climo_ensemble_data_member$MEM.grd $OUTPUT/gues/$MEM/$IYYYY$IMM$IDD$IHH.grd   
    cp /skydata2/dylanelliott/letkf-hybrid-speedy/DATA/era5_trained_hybrid_start_forecast_from_1_9/era5_trained_anal_1_9_2011010700.grd $OUTPUT/gues/$MEM/$IYYYY$IMM$IDD$IHH.grd   
