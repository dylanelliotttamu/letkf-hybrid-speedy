...
do
    ...
    cp /skydata2/dylanelliott/letkf-hybrid-speedy/DATA/speedy_start_forecast_from_speedy_anal_file_1_9/speedy_anal_1_9_2011010700.grd $OUTPUT/gues/$MEM/$IYYYY$IMM$IDD$IHH.grd   
