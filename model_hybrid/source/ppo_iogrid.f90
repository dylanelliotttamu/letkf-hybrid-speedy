...
!    include "com_anomvar.h"
    ...
    if (imode.eq.1) then
        ...
        qg1_ic = qgr 
        ! DYLAN printing 
        print *, 'qg1_ic inside ppo_iogrid', qg1_ic(28*54,:)
        print *, 'qgr4 inside ppop_iogrid', qgr4(28*54,:) 
        print *, 'tg1_ic inside ppo_iogrid', tg1_ic(28*54,:)         
        ...
        print *,' Hybrid UGR  :',minval(ugr1),maxval(ugr1)
        print *,' Hybrid VGR  :',minval(vgr1),maxval(vgr1)
        print *,' Hybrid TGR  :',minval(tgr1),maxval(tgr1)
        print *,' Hybrid QGR  :',minval(qgr1),maxval(qgr1)
        print *,' Hybrid PSGR :',minval(psgr),maxval(psgr)
        print *, 'qg1_ic inside ppo_iogrid', qgr_h(28*54,:)
        print *, 'qgr4 inside ppop_iogrid', qgr1(28*54,:)
        print *, 'tg1_ic inside ppo_iogrid', tgr1(28*54,:)
        ...
        print *, 'qg1_ic inside ppo_iogrid', qgr4(28*54,:)
