...
subroutine initialize_model_parameters(model_parameters,processor,num_of_procs)
   ...
   model_parameters%trial_name ='6000_20_20_20_beta_res1.0_beta_model_0.01_prior_0.0_overlap1_vertlevel_1_era5_uniform_29yr_training_cov_1_5_speedy_iterative1_offbyonebugfix'!'6000_20_20_20_beta_res1.0_beta_model_0.01_prior_0.0_overlap1_vertlevel_1_era5_uniform_29yr_training_cov_1_5_speedy_iterative1_offbyonebugfix'
   !'6000_20_20_20_beta_res1.0_beta_model_0.01_prior_0.0_overlap1_vertlevel_1_speedy_letkf_analysis_9yr_training' !'6000_20_20_20_sigma0.5_beta_res0.001_beta_model_1.0_prior_0.0_overlap1_best_case_model_da_9_year_training'
   !'6000_20_20_20_beta_res1.0_beta_model_0.01_prior_0.0_overlap1_vertlevel_1_speedy_letkf_analysis_9yr_training' !14d_0.9rho_10noise_beta0.001_20years'  
...
subroutine write_res_state(reservoir,model_parameters,grid,x)
  ...
  ! is "ens_member" even indexed correctly?
  print *, "ens_member_dylanwritetest ", ens_member
...
subroutine write_controller_file(model_parameters)
   ...
   file_path = '/skydata2/dylanelliott/ML_SPEEDY_WEIGHTS_uniform_29yr_training_cov_1_5_speedy_iterative1_offbyonebugfix/'//trim(model_parameters%trial_name)//'_controller_file.txt'
