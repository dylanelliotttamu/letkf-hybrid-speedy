...
subroutine initialize_model_parameters(model_parameters,processor,num_of_procs)
   ...
   !model_parameters%trial_name = '6000_20_20_20_beta_res1.0_beta_model_0.01_prior_0.0_overlap1_vertlevel_1_era5_uniform_29yr_training'
   model_parameters%trial_name = '6000_20_20_20_beta_res1.0_beta_model_0.01_prior_0.0_overlap1_vertlevel_1_era5_uniform_29yr_training_iterative2_offbyonebugfix'!'6000_30_30_30_beta_res0.01_beta_model_0.01_prior_0.0_overlap1_vertlevel_1_speedy_letkf_analysis_19yr_training' !14d_0.9rho_10noise_beta0.001_20years'  
   ...
   model_parameters%traininglength = 8760*19! 8760*19!14000*6 !166440 - 24*10  !87600*2+24*10!3+24*10!188280 !254040 !81600!188280!0!0!0!166600!81600 !00!58000!67000!77000
...
subroutine allocate_res_new(reservoir,grid,model_parameters)
  ...
  reservoir%beta_res = 0.01_dp !1.0_dp
...
subroutine write_trained_res(reservoir,model_parameters,grid)
  ...
  file_path = '/skydata2/troyarcomano/ML_SPEEDY_WEIGHTS/'
...
subroutine write_controller_file(model_parameters)
   ...
   file_path = '/skydata2/troyarcomano/ML_SPEEDY_WEIGHTS/'//trim(model_parameters%trial_name)//'_controller_file.txt'
